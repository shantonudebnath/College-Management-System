...
import {
  ...
  IdCard, TrendingUp, LayoutGrid, User, X, HelpCircle, Globe, ClipboardCheck, Scroll, Printer
} from 'lucide-react';
...
const MENU = [
  ...
  { label: 'পরিচয়পত্র প্রিন্ট', href: '/admin/id-cards', icon: Printer },
  ...
  { label: 'প্রশ্নপত্র', href: '/admin/questions', icon: HelpCircle },
