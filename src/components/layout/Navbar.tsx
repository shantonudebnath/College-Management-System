...
const NAV_LINKS: NavItem[] = [
  { label: 'হোম', href: '/' },
  {
    label: 'প্রতিষ্ঠান',
    children: [
      { label: 'প্রতিষ্ঠান পরিচিতি', href: '/about?section=about' },
      { label: 'পরিচালনা পর্ষদ', href: '/about?section=governing-body' },
      { label: 'অনুমতি ও স্বীকৃতি', href: '/about?section=recognition' },
      { label: 'এমপিও তথ্য', href: '/about?section=mpo' },
      { label: 'ভূমি তথ্য', href: '/about?section=land' },
      { label: 'ভবন ও কক্ষ সংখ্যা', href: '/about?section=building' },
      { label: 'ক্যাম্পাস ম্যাপ', href: '/about?section=campus-map' },
      { label: 'বার্ষিক প্রতিবেদন', href: '/about?section=annual-report' },
    ],
  },
  {
    label: 'একাডেমিক তথ্য',
    children: [
      { label: 'শ্রেণি তালিকা', href: '/about?section=classes' },
      { label: 'পরীক্ষার সময়সূচী', href: '/about?section=exam-schedule' },
      { label: 'ফলাফল', href: '/result' },
      { label: 'সিলেবাস', href: '/about?section=syllabus' },
      { label: 'বৃত্তি ও সুবিধা', href: '/about?section=scholarship' },
    ],
  },
  {
