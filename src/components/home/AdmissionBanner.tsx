...
export default function AdmissionBanner() {
  return (
    <section className="bg-[#006633] py-14">
      <div className="max-w-7xl mx-auto px-6 lg:px-14">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/admission"
              className="group inline-flex items-center justify-center gap-2 bg-white text-[#006633] font-black px-7 py-3.5 rounded-lg text-sm hover:bg-green-50 transition-all shadow-lg"
            >
              <FileText size={15} />
              আবেদন ফর্ম
