...
export const DEFAULT_ABOUT: AboutPageContent = {
  ...
  governingBody: [
    { role: 'সভাপতি', name: 'জনাব মো. আবুল কাশেম', photo: '' },
    { role: 'সহ-সভাপতি', name: 'জনাব মো. রফিকুল ইসলাম', photo: '' },
    { role: 'সদস্য সচিব / অধ্যক্ষ', name: 'জনাব মো. শফিকুল ইসলাম', photo: '' },
    { role: 'শিক্ষক প্রতিনিধি (১)', name: 'জনাব মো. আব্দুল আজিজ', photo: '' },
    { role: 'শিক্ষক প্রতিনিধি (২)', name: 'জনাব মো. হাবিবুর রহমান', photo: '' },
    { role: 'অভিভাবক প্রতিনিধি (১)', name: 'জনাব মো. হাসানুজ্জামান', photo: '' },
    { role: 'অভিভাবক প্রতিনিধি (২)', name: 'জনাব মো. নুরুল ইসলাম', photo: '' },
    { role: 'দাতা সদস্য', name: 'জনাব মো. মোস্তফা কামাল', photo: '' },
    { role: 'মহিলা সদস্য', name: 'জনাব মোছাঃ নূরজাহান বেগম', photo: '' },
    { role: 'সরকার মনোনীত সদস্য', name: 'উপজেলা মাধ্যমিক শিক্ষা কর্মকর্তা', photo: '' },
  ],

  recognitionText: `প্রতিষ্ঠান অনুমতি ও সরকারি স্বীকৃতি

স্বীকৃতি প্রদানকারী কর্তৃপক্ষ: বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড (BMEB)
ঠিকানা: বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড, মহাখালী, ঢাকা-১২১২

মূল তথ্য:
প্রতিষ্ঠার সাল      : ১৯৫৮
বোর্ড স্বীকৃতি      : ১৯৬২ সাল
MPO ভুক্তি        : ১৯৭৫ সাল
EIIN নম্বর        : ১১০৫৯০
ইনডেক্স নম্বর      : ৩০৫০৭
প্রতিষ্ঠানের ধরন    : বেসরকারি (MPO ভুক্ত)

স্বীকৃত শ্রেণি ও স্তর:
• ইবতেদায়ী (১ম – ৫ম শ্রেণি)
  অনুমোদনকারী: প্রাথমিক ও গণশিক্ষা মন্ত্রণালয়, গণপ্রজাতন্ত্রী বাংলাদেশ সরকার

• জুনিয়র দাখিল (৬ষ্ঠ – ৮ম শ্রেণি)
  অনুমোদনকারী: বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড (BMEB)

• দাখিল (৯ম – ১০ম শ্রেণি)
  অনুমোদনকারী: বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড (BMEB)

• আলিম (একাদশ – দ্বাদশ শ্রেণি)
  অনুমোদনকারী: বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড (BMEB)

বিশেষ দ্রষ্টব্য: এই প্রতিষ্ঠান বাংলাদেশ সরকারের শিক্ষা মন্ত্রণালয় ও বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড কর্তৃক নিবন্ধিত ও স্বীকৃত। BANBEIS তথ্য ভান্ডারে এই প্রতিষ্ঠানের পূর্ণ তথ্য সংরক্ষিত আছে।`,

  mpoText: `MPO (Monthly Pay Order) তথ্য

বাংলাদেশ সরকারের শিক্ষা মন্ত্রণালয় কর্তৃক এই প্রতিষ্ঠান MPO তালিকাভুক্ত। MPO ব্যবস্থায় সরকার শিক্ষক ও কর্মচারীদের মূল বেতন ও নির্ধারিত ভাতা প্রদান করে।

MPO কোড (Index)  : ৩০৫০৭
তালিকাভুক্তির বছর : ১৯৭৫ সাল
সর্বশেষ হালনাগাদ  : ২০২৩ সাল
...
অফিস সহকারী কাম কম্পিউটার| ২ জন
পিয়ন / নৈশ প্রহরী        | ৬ জন
মোট MPO-ভুক্ত            | ৪১ জন

বেতন ও ভাতা:
জাতীয় বেতনস্কেল ২০১৫ অনুযায়ী মূল বেতনের ১০০% সরকার বহন করে। এছাড়া উৎসব ভাতা, বাড়ি ভাড়া ভাতা ও চিকিৎসা ভাতা সরকারি নিয়মে প্রদান করা হয়।

বিস্তারিত তথ্য:
শিক্ষা মন্ত্রণালয়: www.moedu.gov.bd
BANBEIS: www.banbeis.gov.bd`,
...
গেস্টরুম: ১টি`,
  ...
  examScheduleText: `প্রতিষ্ঠানে পরীক্ষার রুটিন:

অভ্যন্তরীণ পরীক্ষা:
• অর্ধবার্ষিক পরীক্ষা: জুন-জুলাই
...
আবেদনের জন্য প্রতিষ্ঠানের অফিসে যোগাযোগ করুন।`,
  ...
  annualReportText: `বার্ষিক প্রতিবেদন ও তথ্য

প্রতিষ্ঠান প্রতি বছর বার্ষিক প্রতিবেদন প্রকাশ করে। প্রতিবেদনে শিক্ষার্থী ভর্তি, পরীক্ষার ফলাফল, আর্থিক আয়-ব্যয় ও উন্নয়ন কার্যক্রমের তথ্য অন্তর্ভুক্ত থাকে।

শিক্ষাবর্ষ ২০২৫-২৬ সারসংক্ষেপ:
মোট শিক্ষার্থী         : ১,২০০+
মোট শিক্ষক ও কর্মচারী  : ৪৫+
দাখিল পরীক্ষায় পাশের হার: ৯৮%
A+ প্রাপ্ত শিক্ষার্থী  : ১২ জন
বৃত্তিপ্রাপ্ত শিক্ষার্থী : ৩৫ জন

উন্নয়নমূলক কার্যক্রম (২০২৫-২৬):
• নতুন শ্রেণিকক্ষ নির্মাণ সম্পন্ন
• ডিজিটাল ক্লাসরুম স্থাপন
• পাঠাগার সম্প্রসারণ ও নতুন বই সংযোজন
• খেলার মাঠ সংস্কার ও সৌন্দর্যায়ন
