...
export const SUBJECTS_BY_CLASS: Record<string, Subject[]> = {
  // ইবতেদায়ি ১ম ও ২য় শ্রেণি — মোট ৬০০ নম্বর, পাসমার্ক ৪০%
  'class-1': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Arabic', nameBn: 'আরবি', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Aqaid & Fiqh', nameBn: 'আকাইদ ও ফিকহ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Bengali', nameBn: 'বাংলা', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'English', nameBn: 'ইংরেজি', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Mathematics', nameBn: 'গণিত', fullMark: 100, passMark: 40, type: 'theory' },
  ],
  'class-2': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Arabic', nameBn: 'আরবি', fullMark: 100, passMark: 40, type: 'theory' },
  ...
  // ইবতেদায়ি ৩য় ও ৪র্থ শ্রেণি — মোট ৮০০ নম্বর, পাসমার্ক ৪০%
  'class-3': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Arabic 1st Paper', nameBn: 'আরবি ১ম পত্র', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Aqaid & Fiqh', nameBn: 'আকাইদ ও ফিকহ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Bengali', nameBn: 'বাংলা', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'English', nameBn: 'ইংরেজি', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Mathematics', nameBn: 'গণিত', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Bangladesh & World Studies', nameBn: 'বাংলাদেশ ও বিশ্ব পরিচয়', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Science', nameBn: 'বিজ্ঞান', fullMark: 100, passMark: 40, type: 'theory' },
  ],
  'class-4': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Arabic 1st Paper', nameBn: 'আরবি ১ম পত্র', fullMark: 100, passMark: 40, type: 'theory' },
  ...
  // ইবতেদায়ি ৫ম শ্রেণি — মোট ৯০০ নম্বর (আরবি ২য় পত্র যুক্ত), পাসমার্ক ৪০%
  'class-5': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Arabic 1st Paper', nameBn: 'আরবি ১ম পত্র', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Arabic 2nd Paper', nameBn: 'আরবি ২য় পত্র', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Aqaid & Fiqh', nameBn: 'আকাইদ ও ফিকহ', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Bengali', nameBn: 'বাংলা', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'English', nameBn: 'ইংরেজি', fullMark: 100, passMark: 40, type: 'theory' },
    { name: 'Mathematics', nameBn: 'গণিত', fullMark: 100, passMark: 40, type: 'theory' },
  ...
  // জুনিয়র দাখিল ৬ষ্ঠ ও ৭ম শ্রেণি — পাসমার্ক ৩৩
  'class-6': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 33, type: 'theory' },
    ...
    { name: 'Bangladesh & World Studies', nameBn: 'বাংলাদেশ ও বিশ্ব পরিচয়', fullMark: 100, passMark: 33, type: 'theory' },
  ...
  // দাখিল ৯ম-১০ম শ্রেণি (সাধারণ বিভাগ) — মোট ১৪০০ নম্বর, পাসমার্ক ৩৩
  'class-9': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Hadith Sharif', nameBn: 'হাদিস শরিফ', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Aqaid & Fiqh', nameBn: 'আকাইদ ও ফিকহ', fullMark: 100, passMark: 33, type: 'theory' },
    ...
    { name: 'Islamic History', nameBn: 'ইসলামের ইতিহাস', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Bengali 1st Paper', nameBn: 'বাংলা ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Bengali 2nd Paper', nameBn: 'বাংলা ২য় পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'English 1st Paper', nameBn: 'ইংরেজি ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'English 2nd Paper', nameBn: 'ইংরেজি ২য় পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Mathematics', nameBn: 'গণিত', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'ICT', nameBn: 'তথ্য ও যোগাযোগ প্রযুক্তি', fullMark: 50, passMark: 17, type: 'practical' },
    { name: 'Career Education', nameBn: 'ক্যারিয়ার শিক্ষা', fullMark: 50, passMark: 17, type: 'practical' },
    { name: 'Bangladesh & World Studies', nameBn: 'বাংলাদেশ ও বিশ্বপরিচয়', fullMark: 100, passMark: 33, type: 'theory' },
  ],
  'class-10': [
    { name: 'Quran Majid & Tajwid', nameBn: 'কুরআন মাজিদ ও তাজভিদ', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Hadith Sharif', nameBn: 'হাদিস শরিফ', fullMark: 100, passMark: 33, type: 'theory' },
  ...
  // আলিম ১ম বর্ষ (একাদশ শ্রেণি) — সাধারণ বিভাগ, মোট ১৫০০ নম্বর
  'class-alim-1': [
    { name: 'Quran Majid', nameBn: 'কুরআন মাজিদ', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Hadith & Usul al-Hadith', nameBn: 'হাদিস ও উসূলুল হাদিস', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Al-Fiqh 1st Paper', nameBn: 'আল-ফিকহু ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Al-Fiqh 2nd Paper', nameBn: 'আল-ফিকহু ২য় পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Arabic Literature 1st Paper', nameBn: 'আরবি সাহিত্য ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Arabic Literature 2nd Paper', nameBn: 'আরবি সাহিত্য ২য় পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Islamic History', nameBn: 'ইসলামের ইতিহাস', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Balaghat & Mantiq', nameBn: 'বালাগাত ও মানতিক', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Bengali 1st Paper', nameBn: 'বাংলা ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Bengali 2nd Paper', nameBn: 'বাংলা ২য় পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'English 1st Paper', nameBn: 'ইংরেজি ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'English 2nd Paper', nameBn: 'ইংরেজি ২য় পত্র', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'ICT', nameBn: 'তথ্য ও যোগাযোগ প্রযুক্তি', fullMark: 100, passMark: 33, type: 'practical' },
  ],
  // আলিম ২য় বর্ষ (দ্বাদশ শ্রেণি) — সাধারণ বিভাগ, মোট ১৫০০ নম্বর
  'class-alim-2': [
    { name: 'Quran Majid', nameBn: 'কুরআন মাজিদ', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Hadith & Usul al-Hadith', nameBn: 'হাদিস ও উসূলুল হাদিস', fullMark: 100, passMark: 33, type: 'theory' },
    { name: 'Al-Fiqh 1st Paper', nameBn: 'আল-ফিকহু ১ম পত্র', fullMark: 100, passMark: 33, type: 'theory' },
...
// দাখিল/আলিম (৬ষ্ঠ-দ্বাদশ শ্রেণি) — BMEB মান অনুযায়ী, পাসমার্ক ৩৩
export const GRADE_SCALE = [
  ...
  { min: 50, max: 59, grade: 'B', gpa: 3.0, label: 'ভালো' },
  { min: 40, max: 49, grade: 'C', gpa: 2.0, label: 'সন্তোষজনক' },
  { min: 33, max: 39, grade: 'D', gpa: 1.0, label: 'নিম্নমান' },
  { min: 0, max: 32, grade: 'F', gpa: 0.0, label: 'অকৃতকার্য' },
];

// ইবতেদায়ি (১ম-৫ম শ্রেণি) — BMEB মূল্যায়ন নির্দেশিকা ২০২৬ অনুযায়ী, পাসমার্ক ৪০%
export const EBTEDAYI_GRADE_SCALE = [
  { min: 80, max: 100, grade: 'A', label: 'অতি উত্তম' },
  { min: 60, max: 79, grade: 'B', label: 'উত্তম' },
  { min: 40, max: 59, grade: 'C', label: 'সন্তোষজনক' },
  { min: 0, max: 39, grade: 'D', label: 'সহায়তা প্রয়োজন' },
];

export function getGradeScale(classId: string) {
  const ebtedayiClasses = ['class-1', 'class-2', 'class-3', 'class-4', 'class-5'];
  return ebtedayiClasses.includes(classId) ? EBTEDAYI_GRADE_SCALE : GRADE_SCALE;
}
